...
let dependencies = Dependencies(
  ...
  swiftPackageManager: SwiftPackageManagerDependencies(
    [
      ...
      .remote(url: "https://github.com/pointfreeco/swift-composable-architecture.git", requirement: .exact("1.6.0")),
      .remote(url: "https://github.com/Team-Archive/ImageLoader-iOS.git", requirement: .exact("0.1")),
      .remote(url: "https://github.com/Team-Archive/Network-iOS.git", requirement: .exact("0.2"))
    ],
    productTypes: [
